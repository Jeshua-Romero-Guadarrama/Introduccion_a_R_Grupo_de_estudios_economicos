...
```{r echo=FALSE, fig.height=6, fig.width=12, out.width = "90%"}
...
```{r echo=FALSE, fig.height=12, fig.width=12, out.width = "90%"}
...
Hay varios paquetes que implementan este procedimiento (e.g. `r citepkg("e1071")`, `r citepkg("svmpath")`, Hastie *et al.*, 2004), aunque se considera que el más completo es `r citepkg("kernlab")` (Karatzoglou *et al.*, 2004).
