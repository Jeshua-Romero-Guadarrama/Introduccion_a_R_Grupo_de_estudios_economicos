...
-   Se hace el correspondiente histograma y gráfico de cajas
    ...
    ##   98.96  103.57  104.95  104.93  106.14  110.47
    ```
    ...
    <img src="14-Introduccion_files/figure-epub3/unnamed-chunk-17-1.png" width="80%" style="display: block; margin: auto;" />
    
    ```r
    boxplot(x) # gráfico de cajas
    ```
    
    <img src="14-Introduccion_files/figure-epub3/unnamed-chunk-17-2.png" width="80%" style="display: block; margin: auto;" />
